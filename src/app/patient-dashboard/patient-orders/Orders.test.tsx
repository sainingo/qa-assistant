...
// import { fetchActiveOrders, fetchVoidedOrders, gettingPatientName } from './Order.resource';
...
//   global.localStorage.setItem('userInformation', JSON.stringify({ user: { privileges: [] } }));
...
//       </BrowserRouter>,
//     );
//     const noOrders = await screen.findByText(/No orders found for this patient/i);
...
//     const tableHeaders = queryAllByText(container, /order number|order|date activated|ordered by|urgency|action/i);
...
//     expect(mockHandleVoidOrder).toHaveBeenLastCalledWith(id, privilege, orderUuid);
//   });
// });
